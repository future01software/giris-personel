...
const PersonnelAdd = () => {
  ...
  const inputDark =
    'bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500';
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6">
          <h3
            className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4 uppercase"
            style={{ fontFamily: 'Oswald, sans-serif' }}
          >
            {t('personnelInfo')}
          </h3>
        ...
        <div className="bg-blue-50 dark:bg-slate-900 rounded-xl border border-blue-200 dark:border-slate-800 p-6">
          <h3
            className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4 uppercase"
            style={{ fontFamily: 'Oswald, sans-serif' }}
          >
