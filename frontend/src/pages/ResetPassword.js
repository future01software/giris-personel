        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
                <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
                    ...
                    <h2 className="text-2xl font-bold mb-2">{i18n.language === 'tr' ? 'Geçersiz Bağlantı' : 'Invalid Link'}</h2>
                    <p className="text-slate-500 mb-6">{i18n.language === 'tr' ? 'Bu bağlantı geçersiz veya süresi dolmuş.' : 'This link is invalid or has expired.'}</p>
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
            <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl max-w-md w-full border border-slate-100 dark:border-slate-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <Input
                                ...
                                className="pl-10 h-11 bg-slate-50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-blue-500/20"
                                placeholder="••••••"
                                required
                            />
                            <button
                    ...
                    <Button type="submit" className="w-full h-11 premium-gradient rounded-xl font-bold shadow-lg shadow-blue-500/25" disabled={loading}>
                        {loading ? (
