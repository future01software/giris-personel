        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-full hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm hover:shadow-md flex items-center gap-2 text-sm font-bold"
            >
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${ioFilter === 'OUT'
                  ...
                  : 'bg-red-50 dark:bg-red-950/30 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800 hover:bg-red-100 dark:hover:bg-red-900/50'
                  }`}
              >
                <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 text-sm"
              />
              <button
                onClick={fetchDayTotals}
                disabled={dayTotalsLoading}
                className="px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-sm font-medium text-slate-700 dark:text-slate-200 disabled:opacity-50"
              >
                {t('refresh')}
              </button>
          ...
          {filteredLogs.length === 0 ? (
            ...
            filteredLogs.map((log) => {
              ...
              return (
                <div
                  key={log.id}
                  className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all group flex flex-col md:flex-row gap-4 items-start md:items-center justify-between"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className={`md:hidden inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-bold tracking-wider text-white uppercase ${isIn ? 'bg-emerald-500' : 'bg-red-600'
                        }`}>
                  ...
                  <div className="w-full md:w-auto flex items-center justify-between md:justify-end gap-6 md:pl-6 md:border-l md:border-slate-100 md:dark:border-slate-800">
                    ...
                    <div className="text-right">
                      ...
                      <div className={`text-sm font-bold font-mono tracking-tight ${isIn ? 'text-emerald-600' : 'text-slate-900 dark:text-white'}`}>
                    ...
                    <div className="flex flex-col items-end gap-1 min-w-[80px]">
                      <div className={`w-full text-center py-1.5 rounded-lg text-xs font-bold tracking-widest text-white uppercase shadow-sm ${isIn ? 'bg-emerald-500 shadow-emerald-200' : 'bg-red-600 shadow-red-200'
                        }`}>
                        {isIn ? t('entryBadge') : t('exitBadge')}
                      </div>
